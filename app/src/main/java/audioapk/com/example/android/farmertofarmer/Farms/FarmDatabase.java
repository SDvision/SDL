...
public class FarmDatabase extends SQLiteOpenHelper{
    ...
    public void insetFarm(String title,int img,String land,String date){
    ...
    public void getAll(int value){
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("Select * from "+DB_TABLE_FARM+" where _id = ?",new String[]{String.valueOf(value)});
    }
